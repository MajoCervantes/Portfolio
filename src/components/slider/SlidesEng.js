...
const slidesInfo = [
  {
    ...
    desc:
      'App that provides information about each country and weather in real time, created with React and API',
  },
  {
    src: Shopsi,
    alt: 'Shopsi App',
    ...
    <a
      href={`${
        slide.src === Shopsi
          ...
          ? 'https://encamino.com/'
          : slide.src === Trivia
          ? 'https://trivia-two.vercel.app/</div>'
          : slide.src === ToDo
          ...
          : 'https://weather-app-virid-three.vercel.app/'
      }`}
      target="_blank"
    >
